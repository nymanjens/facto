...
object Table {
  ...
  def apply[T](title: String,
               ...
               colspan: Int = 9999,
               entries: Seq[T])(tableHeaders: Html)(entryToTableDatas: T => Html)(
      implicit messages: Messages): Html = {
    val tableDatas = entries map entryToTableDatas
    views.html.accounting.parts.Table(
      title,
      tableClasses,
      allEntriesLink,
      numEntriesShownByDefault,
      colspan,
      tableHeaders,
      tableDatas)
  }

  def withIndexedEntries[T](title: String,
                            tableClasses: String = "",
                            allEntriesLink: Option[Call] = None,
                            numEntriesShownByDefault: Int = defaultNumEntriesShown,
                            colspan: Int = 9999,
                            entries: Seq[T])(tableHeaders: Html)(entryToTableDatas: (T, Int) => Html)(
      implicit messages: Messages): Html = {
