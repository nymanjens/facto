...
class MonthRangeTest extends Specification {
  ...
  private val dateA = LocalDate.of(2012, MARCH, 1)
  private val dateB = LocalDate.of(2012, APRIL, 1)
  private val dateC = LocalDate.of(2012, MAY, 1)
  private val dateD = LocalDate.of(2012, JUNE, 1)

  "forYear factory method" in {
    val range = MonthRange.forYear(1998)
    range.start mustEqual LocalDate.of(1998, JANUARY, 1)
    range.startOfNextMonth mustEqual LocalDate.of(1999, JANUARY, 1)
  }
  ...
  "countMonths" in {
    val range = MonthRange(LocalDate.of(1998, FEBRUARY, 1), LocalDate.of(1999, JUNE, 1))
  ...
  "contains DateTime" in {
    ...
    closedRange.contains(LocalDate.of(2012, FEBRUARY, 27)) mustEqual false
    closedRange.contains(dateA) mustEqual true
    closedRange.contains(LocalDate.of(2012, MARCH, 2)) mustEqual true
  ...
  "contains DatedMonth" in {
    ...
    closedRange.contains(DatedMonth.containing(LocalDate.of(2012, FEBRUARY, 27))) mustEqual false
    closedRange.contains(DatedMonth.containing(dateA)) mustEqual true
    closedRange.contains(DatedMonth.containing(LocalDate.of(2012, MARCH, 2))) mustEqual true
